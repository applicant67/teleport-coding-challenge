...
func Test_CommandOutput_write_into_buffer(t *testing.T) {
	t.Parallel()

	output := NewCommandOutput()

	bytesWritten, err := output.Write([]byte("hello"))
	if err != nil {
...
func Test_CommandOutput_Expecting_Error_when_write_into_Closed_buffer(t *testing.T) {
	t.Parallel()
...
func Test_CommandOutput_Read_Partial_from_buffer(t *testing.T) {
	t.Parallel()
...
func Test_CommandOutput_Expecting_returns_EOF_when_ReadPartial_from_Closed_(t *testing.T) {
	t.Parallel()
...
func Test_CommandOutput_Concurrent_Read_and_Writes(t *testing.T) {
...
func Test_CommandOutput_Concurrent_Writes(t *testing.T) {
	t.Parallel()
