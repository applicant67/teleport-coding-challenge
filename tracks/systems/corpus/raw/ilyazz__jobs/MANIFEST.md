...
- Captured: 2026-05-11T17:57:51Z
- Track: systems
- Upstream: https://github.com/ilyazz/jobs

## Files

- `repo.json` - repository metadata at capture time
- `pulls.json` - all pull requests (open + closed), 5 entries
- `issues.json` - all issues (open + closed), 6 entries
- `pr-review-comments.json` - line-anchored PR review comments, 89 entries
- `issue-comments.json` - issue + PR conversation comments, 11 entries
