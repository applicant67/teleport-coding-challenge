...
- Captured: 2026-05-11T18:00:40Z
- Track: systems
- Upstream: https://github.com/gstelang/job-worker-service

## Files

- `repo.json` - repository metadata at capture time
- `pulls.json` - all pull requests (open + closed), 6 entries
- `issues.json` - all issues (open + closed), 6 entries
- `pr-review-comments.json` - line-anchored PR review comments, 35 entries
