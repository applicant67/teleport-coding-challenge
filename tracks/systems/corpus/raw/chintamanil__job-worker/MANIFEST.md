...
- Captured: 2026-05-11T17:53:29Z
- Track: systems
- Upstream: https://github.com/chintamanil/job-worker

## Files

- `repo.json` - repository metadata at capture time
- `pulls.json` - all pull requests (open + closed), 7 entries
- `issues.json` - all issues (open + closed), 7 entries
- `pr-review-comments.json` - line-anchored PR review comments, 62 entries
