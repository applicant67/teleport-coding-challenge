# s-gruneberg/jobWorker

- Captured: 2026-05-11T22:29:08Z
- Track: systems
- Upstream: https://github.com/s-gruneberg/jobWorker

## Files

- `repo.json` - repository metadata at capture time
- `pulls.json` - all pull requests (open + closed), 3 entries
- `issues.json` - all issues (open + closed), 3 entries
- `pr-review-comments.json` - line-anchored PR review comments, 25 entries
