# antonefremov/teleport_job_worker

- Captured: 2026-05-12T01:11:59Z
- Track: systems
- Upstream: https://github.com/antonefremov/teleport_job_worker

## Files

- `repo.json` - repository metadata at capture time
- `pulls.json` - all pull requests (open + closed), 0 entries
- `issues.json` - all issues (open + closed), 0 entries
- `pr-review-comments.json` - line-anchored PR review comments, 0 entries
