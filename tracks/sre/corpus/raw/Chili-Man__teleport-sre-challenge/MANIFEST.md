# Chili-Man/teleport-sre-challenge

- Captured: 2026-05-11T18:11:50Z
- Track: sre
- Upstream: https://github.com/Chili-Man/teleport-sre-challenge

## Files

- `repo.json` - repository metadata at capture time
- `pulls.json` - all pull requests (open + closed), 2 entries
- `issues.json` - all issues (open + closed), 2 entries
- `pr-review-comments.json` - line-anchored PR review comments, 8 entries
